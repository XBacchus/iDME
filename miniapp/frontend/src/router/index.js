...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'parts/versions/:id', name: 'PartVersions', component: () => import('../views/parts/VersionHistory.vue') },
      { path: 'parts/categories', name: 'PartCategories', component: () => import('../views/parts/CategoryManage.vue') },
